...
abstract class BoardView extends View {
    ...
    protected List<Position> movePointersToDraw;
    protected List<Position> attackPointersToDraw;

    protected int displayMode;
    protected int oneTileWidth;
    ...
    protected void setMaxTile(int max){
        maxTile = max;
    }
    ...
    protected void drawClassic(Canvas canvas){
        Position temp;
        Drawable pieceImage;
    ...
    protected Position toPixels(Position p){
